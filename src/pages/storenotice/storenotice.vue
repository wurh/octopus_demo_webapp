<template>
	<section class="store-notice-wrap">
        <div style="display:none" v-title>店铺公告</div>
         <account-header title="店铺公告" linkTo="/store/account"></account-header>
         <div class="store-notice-cell">
             <div class="store-notice-input">
            <mu-text-field 
            type="text" fullWidth
         ...
         <div class="store-notice-btn" @click="onConfirm">确认</div>
		 <mu-toast  v-if="toast" :message="showMsg" @close="hideToast" />
	</section>
</template>

<script>
require("./storenotice.css");
